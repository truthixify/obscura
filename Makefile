...
install-barretenberg:
	curl -L https://raw.githubusercontent.com/AztecProtocol/aztec-refs/heads/master/barretenberg/bbup/install | bash
...
deploy-verifier:
	...
	cd contracts && sncast deploy --salt 0x00 --class-hash 0x03100defca27214e5f78f25e48a5b05e45899c6834cb4d34f48384c18e14dff7

declare-contract:
	cd contracts && sncast declare --contract-name Obscura  --package obscura

deploy-contract:
	# TODO: use class hash from the result of the `make declare-contract` step
	cd contracts && sncast deploy --class-hash 0x0481094ffabb454020557ee5022a940cf0065924bf694b206119231de38610cc
...
artifacts:
	...
	cp ./circuit/target/circuit.json ./contracts/assets/circuit.json
	cp ./circuit/target/vk ./contracts/assets/vk.bin
	cp ./contracts/target/release/verifier_UltraStarknetHonkVerifier.contract_class.json ./contracts/assets/verifier.json
