...
type TransactionFunc = (tx: Call[], withSendTransaction?: boolean) => Promise<string | undefined>
...
export const useTransactor = (_walletClient?: AccountInterface): UseTransactorReturn => {
    ...
    const writeTransaction = async (
        ...
        if (!walletClient) {
            ...
            throw 'Cannot access account, please connect your wallet.'
            return
        }
        ...
        try {
            ...
            if (tx != null && withSendTransaction) {
                ...
                try {
                    ...
                    console.log(feeEstimationError)
                    console.warn(
            ...
            const readableError = extractKnownErrorMessage(error) ?? message

            console.error('⚡️ ~ file: useTransactor.tsx ~ error', readableError)

            // notification.error(readableError);
            throw readableError
        }
