...
import { Permission, RequestFnCall, RpcMessage, RpcTypeToMessageMap } from 'get-starknet-core'
...
export class KeplrConnector extends InjectedConnector {
    ...
    async connect(_args: ConnectArgs = {}): Promise<ConnectorData> {
        ...
        ;(this.__wallet.starknet.on as WalletEventListener)('accountsChanged', async accounts => {
